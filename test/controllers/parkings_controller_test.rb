...
class ParkingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parking" do
    assert_difference('Parking.count') do
      post parkings_url, params: { parking: { adress: @parking.adress, name: @parking.name, phone: @parking.phone } }, as: :json
    end
  ...
  test "should update parking" do
    patch parking_url(@parking), params: { parking: { adress: @parking.adress, name: @parking.name, phone: @parking.phone } }, as: :json
    assert_response 200
  end
